...
public class LoadConditions {
  ...
  private static final Codec<ConditionType> CONDITION_TYPE_CODEC = ResourceLocation.CODEC.xmap(
  ...
  public static <T extends ILoadCondition> ConditionType register(ResourceLocation id,
      MapCodec<T> codec) {
  ...
  /**
   * Reads one or more conditions from a JSON element. If the element is an object an array of 1
   * will be returned.
   *
  ...
  /**
   * Tests if a raw JSON element can be loaded. This will search for the condition property and
   * attempt to deserialize and test those conditions.
   *
