...
/**
 * Adapted from Darkhax's <a href="https://github.com/Darkhax-Minecraft/Bookshelf">Bookshelf</a> A
 * CodecHelper wraps a Codec to provide a large amount of helpers and utilities to make working with
 * the Codec easier and more flexible.
 *
...
public class MapCodecHelper<T> {
  ...
  /**
   * A function for creating an array of the codecs type. This allows us to create clean arrays for
   * our codecs without relying on sketchy code.
   */
   ...
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders
   *                  type.
  ...
  /**
   * A helper for defining a field of this type in a RecordCodecBuilder. If the field is not present
  ...
  /**
   * Gets a codec that can read and write an array. For the sake of convenience single elements are
   * treated as an array of one.
   *
  ...
  /**
   * A helper for defining a field for an array of this type in a RecordCodecBuilder. For the sake
   * of convenience single elements are treated as an array of one.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders
   *                  type.
  ...
  /**
   * A helper for defining a field for an array of this type in a RecordCodecBuilder. For the sake
   * of convenience single elements are treated as an array of one. If the field is not present the
  ...
  /**
   * Gets a codec that can read and write a list. For the sake of convenience single elements are
  ...
  /**
   * A helper for defining a field for a list of this type in a RecordCodecBuilder. For the sake of
   * convenience single elements are treated as a list of one.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders
   *                  type.
  ...
  /**
   * A helper for defining a field for a list of this type in a RecordCodecBuilder. For the sake of
   * convenience single elements are treated as a list of one. If the field is not present the
   * fallback will be used.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders
  ...
  /**
   * Gets a codec that can read and write a set. For the sake of convenience single elements are
   * treated as a list of one.
   *
  ...
  /**
   * A helper for defining a field for a set of this type in a RecordCodecBuilder. For the sake of
   * convenience single elements are treated as a set of one.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders
   *                  type.
  ...
  /**
   * A helper for defining a field for a set of this type in a RecordCodecBuilder. For the sake of
   * convenience single elements are treated as a set of one. If the field is not present the
   * fallback will be used.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders
  ...
  /**
   * A helper for defining a field for an optional value of this type in a RecordCodecBuilder. If
   * the field is not present the fallback will be used.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders
   *                  type.
